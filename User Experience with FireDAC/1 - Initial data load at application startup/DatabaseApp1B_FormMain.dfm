object AppFormMain: TAppFormMain
  Left = 0
  Top = 0
  Caption = 'Desktop First UX Summit 2021 - Database Application #1 ( B )'
  ClientHeight = 611
  ClientWidth = 884
  Color = clBtnFace
  ...
  object PanelTop: TPanel
    ...
    object ButtonGetHelp: TSpeedButton
      AlignWithMargins = True
      Left = 801
      Top = 3
      Width = 80
      Height = 43
      Action = ActionGetHelp
      Align = alRight
      Flat = True
      ExplicitLeft = 545
      ExplicitTop = 0
    end
    object DBNavigatorFullOrderWithDetail: TDBNavigator
      AlignWithMargins = True
      Left = 177
      Top = 5
      Width = 252
  ...
  object PanelData: TPanel
    ...
    ExplicitWidth = 880
    ExplicitHeight = 533
    object DBGridFullOrdersWithDetail: TDBGrid
      Left = 0
      Top = 0
      Width = 884
      Height = 534
  ...
  object ActionList1: TActionList
    ...
    object ActionGetHelp: TAction
      Caption = 'Get Help'
      OnExecute = ActionGetHelpExecute
      OnUpdate = ActionGetHelpUpdate
    end
  end
